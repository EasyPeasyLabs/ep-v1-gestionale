...
export const generateInvoicesFromQuote = async (quote: Quote, enrollmentId: string, selectedLessons: Lesson[]): Promise<void> => {
    ...
    // Prevent duplicates: Check for existing ghosts for this enrollment
...
/**
 * @deprecated Fix storici Maggio 2026 spostati in scripts/oneTimeFixMay2026.ts.
 * Questa funzione è mantenuta per compatibilità con i chiamanti esistenti
 * ma non esegue più alcuna operazione.
 */
export const runSmartSanityFix = async (): Promise<void> => {
    console.log('[SanityFix] Nessun fix attivo. I fix storici sono in scripts/oneTimeFixMay2026.ts.');
};
