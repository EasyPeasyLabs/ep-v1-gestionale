...
import { Documento, Associato, ClienteTipo, DocumentoTipoDef } from '../../types';
import { EMPTY_DOCUMENTO, DOCUMENTO_STATO_OPTIONS } from '../../constants';

const DocumentoForm: React.FC<{
    documento: Documento,
    associabili: Associato[],
    documentiTipi: DocumentoTipoDef[],
    onSave: (doc: Documento) => void,
    onCancel: () => void
}> = ({ documento, associabili, documentiTipi, onSave, onCancel }) => {
...
export const Documenti: React.FC = () => {
    const { documenti, addDocumento, updateDocumento, deleteDocumento, clienti, fornitori, documentiTipi } = useMockData();
