...
const categoryDetails: Record<TransactionCategory, { label: string; help: string }> = {
    ...
    [TransactionCategory.Fuel]: { label: 'Carburante', help: 'Benzina, Diesel, GPL per gli spostamenti verso le sedi.' },
    [TransactionCategory.Vehicles]: { label: 'Spese Auto / Logistica', help: 'RCA, Bollo, Manutenzione, Tagliandi, Leasing o Noleggio a Lungo Termine.' },
