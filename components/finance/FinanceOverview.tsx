...
import { Transaction, TransactionType, TransactionCategory, Invoice, DocumentStatus, FinanceStats } from '../../types';
...
const KpiDetailChart: React.FC<{ type: string; stats: FinanceStats; transactions: Transaction[] }> = ({ type, stats, transactions }) => {
