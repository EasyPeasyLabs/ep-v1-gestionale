                    ...
                    <div className="p-4 bg-slate-50 rounded-xl border border-slate-200">
                        ...
                        {isClosed ? (
                            <div className="mt-2">
                                ...
                                <p className="text-xs text-slate-500 mt-1">da {existingYearRecord?.closedBy} il {existingYearRecord?.closedAt ? new Date(existingYearRecord.closedAt).toLocaleDateString() : 'N/A'}</p>
                            </div>
                        ) : (
                            <div className="mt-2">
