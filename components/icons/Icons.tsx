...
export const AnagraficheIcon: React.FC<IconProps> = ({ className = "h-6 w-6" }) => (
...
// FIX: Added missing BrainIcon component
export const BrainIcon: React.FC<IconProps> = ({ className = "h-6 w-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
        <path strokeLinecap="round" strokeLinejoin="round" d="M4.871 14.735c-1.388-1.388-1.388-3.64 0-5.028s3.64-1.388 5.028 0c1.388 1.388 1.388 3.64 0 5.028-1.388 1.388-3.64 1.388-5.028 0z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M14.1 4.418a2.25 2.25 0 013.182 0l2.268 2.268a2.25 2.25 0 010 3.182L13.182 16.23a2.25 2.25 0 01-3.182 0l-2.268-2.268a2.25 2.25 0 010-3.182l6.364-6.364z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.899 19.582a2.25 2.25 0 01-3.182 0l-2.268-2.268a2.25 2.25 0 010-3.182l6.364-6.364a2.25 2.25 0 013.182 0l2.268 2.268a2.25 2.25 0 010 3.182L9.899 19.582z" />
...
export const WorkflowIcon: React.FC<IconProps> = ({ className = "h-6 w-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
