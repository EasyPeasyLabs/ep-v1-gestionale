...
import { Client, ClientInput, ClientType, ParentClient, InstitutionalClient, Child, ParentRating, ChildRating, Note, Enrollment } from '../types';
...
const ClientForm: React.FC<{ client?: Client | null; onSave: (c: ClientInput | Client) => void; onCancel: () => void }> = ({ client, onSave, onCancel }) => {
    ...
    const handlePhoneChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (cleaned.startsWith('+39')) {
            ...
            // If it doesn't start with +39 (e.g., user is typing an international number manually), just allow it
            setPhone(cleaned);
        }
    };
